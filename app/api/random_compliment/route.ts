...
export function GET(request: NextRequest) {
    ...
    let items = [
        ...
        "You are a positive force in any situation.",
        ...
        "You are always open to learning and growing.",
        "You are incredibly supportive of others.",
        "You are so quick-witted and clever.",
        ...
        "You are a fantastic problem solver.",
        "You are a ray of sunshine in people's lives.",
        "You are a genuinely positive influence.",
        "You are always striving to improve.",
        "You are refreshingly honest and genuine.",
        "You are incredibly resourceful.",
        "You are a true visionary.",
        "You are a great source of comfort to others.",
        "You are so incredibly reliable.",
        "You are a great source of strength to those around you.",
        ...
        "You are incredibly tenacious.",
        "You are so humble despite your achievements.",
        "You are a wonderful problem solver.",
        "You are incredibly insightful.",
        "You are a true optimist.",
        "You are wonderfully patient and understanding.",
        "You are a genuinely giving person.",
        "You are a true gift to those around you.",
        "You are so wonderfully charismatic.",
        "You are a true pillar of strength.",
        "You are so exceptionally genuine and authentic.",
        "You are a true source of encouragement to others.",
        "You are incredibly talented and skilled.",
        "You are so wonderfully compassionate.",
        "You are a true gem in this world.",
        "You are a wonderful mentor to others.",
        "You are a true breath of fresh air.",
        "You are incredibly insightful and wise.",
        "You are a true team player, always willing to collaborate.",
        "You are so wonderfully positive and uplifting.",
        "You are a true example of grace under pressure.",
        "You are so wonderfully caring and considerate.",
        "You are a true champion for others.",
        "You are incredibly charismatic and charming.",
        "You are a true joy to be around.",
        "You are so wonderfully open-minded and accepting.",
        "You are a true epitome of courage and bravery.",
        "You are so wonderfully genuine and authentic.",
        "You are a true friend to those in need.",
        "You are incredibly talented and gifted.",
        "You are a true role model for others to follow.",
        "You are so wonderfully supportive and encouraging.",
        "You are a true problem-solving genius.",
        "You are incredibly thoughtful and considerate.",
        "You are a true visionary, always seeing the bigger picture.",
        "You are so wonderfully composed and collected.",
        "You are a true source of wisdom and guidance.",
        "You are incredibly skilled and accomplished.",
        "You are a true master of your craft.",
        "You are so wonderfully positive and uplifting.",
        "You are a true model of resilience and strength.",
        "You are incredibly caring and empathetic.",
        "You are a true source of inspiration for others.",
        "You are so wonderfully reliable and dependable.",
        "You are a true believer in the power of kindness.",
        "You are incredibly diligent and hardworking.",
        "You are a true source of comfort and support to others.",
        "You are so wonderfully encouraging and motivating.",
        "You are a true advocate for others.",
        "You are incredibly articulate and well-spoken.",
        "You are a true source of positivity and optimism.",
        "You are so wonderfully resourceful and adaptable.",
        "You are a true beacon of hope and encouragement.",
        "You are incredibly insightful and perceptive.",
        "You are a true believer in the potential of others.",
